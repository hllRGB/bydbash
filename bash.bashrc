...
PS1="\[\e[m\]┌─\[\e[1;31m\][\[\e[m\]$0-$$ $(echo -n "$time1\[\e[25m\]:\[\e[m\]$time2" $([ $UID = 0 ]&&echo -ne "\[\e[4m\]\[\e[5m\]\[\e[1;31m\]$(whoami)\[\e[m\]"||echo "\[\e[1;34m\]$(whoami)"))\[\e[1;31m\]@\[\e[34m\]\h $smart_pwd\[\e[1;31m\]]\[\e[m\]$(git_current_branch yes)\n└─$([ $ret = 0 ]&&echo -ne "\[\e[1;32m\]"||echo -en "\[\e[1;31m\]$ret")\$>>_\[\e[m\] "
